          ...
          >
            <div className="space-y-6">
              ...
              <p className="text-xl leading-relaxed text-gray-300">
                Nuestro horno de leña, el corazón de nuestra cocina, imparte ese sabor 
                inconfundible que solo la cocción tradicional puede lograr. La madera 
                cuidadosamente seleccionada y el control preciso de la temperatura nos 
                permiten conseguir ese punto exacto de cocción que caracteriza a 
                nuestros pollos asados.
              </p>
            ...
            <div className="relative">
              <img 
                src="/img/horno-lena.jpg" 
                alt="Nuestro horno de leña tradicional"
                className="rounded-lg shadow-2xl"
              />
              <div className="absolute -bottom-6 -right-6 bg-[#D4AF37] p-4 rounded-lg shadow-xl">
