        ...
        <div key={date} className="w-full">
          ...
          <div className="w-full overflow-x-auto">
            <Table className="w-full min-w-[600px]">
              <TableHeader>
                <TableRow>
                  <TableHead className="text-base md:text-lg px-2 md:px-4">Cliente</TableHead>
                  <TableHead className="text-base md:text-lg text-center px-2 md:px-4">Pollos</TableHead>
                  <TableHead className="text-base md:text-lg text-center px-2 md:px-4">Hora</TableHead>
                  <TableHead className="hidden md:table-cell text-lg px-2 md:px-4">Detalles</TableHead>
                  <TableHead className="text-base md:text-lg text-center px-2 md:px-4">Acciones</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
                {dateOrders.map((order, index) => (
                  <TableRow key={order.id} className={index % 2 === 0 ? "bg-gray-100" : "bg-white"}>
                    <TableCell className="text-base md:text-lg font-medium px-2 md:px-4">
                    ...
                    <TableCell className="px-2 md:px-4">
                      <div className="flex gap-1 md:gap-2 justify-center">
                        <Button
                          ...
                          className="relative w-8 h-8 md:w-10 md:h-10 p-1 md:p-2 text-base md:text-lg hover:bg-gray-200"
                          disabled={isLoading}
                        >
                          {isLoading ? <Loader2 className="h-4 w-4 md:h-5 md:w-5 animate-spin" /> : '🔘'}
                        ...
                        {order.customerPhone && !order.notificado && !notifiedOrders[order.id] && (
                          <Button
                            ...
                            className="w-8 h-8 md:w-10 md:h-10 p-1 md:p-2 text-base md:text-lg hover:bg-green-100 shadow-md"
