...
export function NewOrderDrawer({ isOpen, onOpenChange }: NewOrderDrawerProps) {
  ...
  return (
    <Drawer open={isOpen} onOpenChange={onOpenChange}>
        <DrawerContent className="h-screen md:h-auto max-h-screen w-full md:max-w-[80%] lg:max-w-[70%] xl:max-w-[60%] flex flex-col bg-gray-50">
        <DrawerHeader className="bg-[#FFEAEC] border-b border-gray-200">
          <DrawerTitle className="text-3xl md:text-4xl lg:text-5xl text-center text-[#E61D2A]">Nuevo Encargo</DrawerTitle>
        </DrawerHeader>
        <form onSubmit={handleSubmit} className="p-4 md:p-6 my-2 md:my-4 space-y-4 md:space-y-6 flex-grow overflow-auto text-base md:text-xl lg:text-2xl">
          ...
          <Button 
            type="submit"
            className="bg-[#E61D2A] hover:bg-[#c91824] text-white w-full p-3 md:p-4 lg:p-6 my-2 md:my-3 lg:my-4 text-base md:text-xl lg:text-2xl font-semibold"
